...
global.github = 'https://github.com/itxwasi/JUPITER-MD'
global.location = 'pakistan'
global.gurl = 'https://instagram.com/naveeddogar_' // add your username
global.sudo = process.env.SUDO || '923259823531'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'JUPITER-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'WASI-TECH' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'Naveed-Dogar' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'WASI' : process.env.PACK_NAME.split(";")[1],
